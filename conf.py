...
BLOG_AUTHOR = "Hiranmayi Duvvuri"  # (translatable)
...
# before </head>
# (translatable)
EXTRA_HEAD_DATA = r'<script type="text/javascript" src="https://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML"> </script>'
